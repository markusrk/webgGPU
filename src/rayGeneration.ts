...
export const computeRayDirection = ti.func((theta: number, alpha: number) => {
...
export const getRayForAngle = ti.func((verticalStep, horizontalStep, i, j): ti.Vector => {
...
export const getVscScoreAtAngle = ti.func((rayDirection, verticalStep, horizontalStep) => {
